package com.gabriaum.skills.util.inventory.controller;

import com.gabriaum.skills.util.inventory.InventoryListener;
...
import com.gabriaum.skills.util.inventory.opener.ChestInventoryOpener;
import com.gabriaum.skills.util.inventory.opener.InventoryOpener;
import com.gabriaum.skills.util.inventory.opener.SpecialInventoryOpener;
...
public class InventoryController {
    ...
    public InventoryController(JavaPlugin plugin, int ticksToUpdate) {
        this.plugin = plugin;
        ...
        this.plugin.getServer().getPluginManager().registerEvents(new InvListener(), plugin);

        new InvTask().runTaskTimer(plugin, ticksToUpdate, ticksToUpdate);
    }
